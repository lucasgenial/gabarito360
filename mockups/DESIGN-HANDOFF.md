# 03f5ca44-ae6a-41d1-b9e3-ebc3e36bbd4a implementation handoff

This archive is the source of truth for turning the design into production code. Start from `acompanhar-correcao-turma.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `acompanhar-correcao-turma.html`
- HTML screens detected: 30
...
- A single self-contained `acompanhar-correcao-turma.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `acompanhar-correcao-turma.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `acompanhar-correcao-turma.html`
- `acompanhar-correcao.html`
- `aluno-cadastrar-redesign.html`
- `aluno-cadastrar.html`
- `aluno-detalhe.html`
- `aluno-editar.html`
- `configuracoes.html`
- `criar-prova.html`
...
- `dashboard-diretor-escolar.html`
...
- `gabarito.html`
- `login.html`
- `membro-cadastrar.html`
- `membro-editar.html`
- `perfil.html`
- `perfis-equipe.html`
- `provas.html`
- `relatorio-prova.html`
- `relatorio-turma-prova.html`
- `resultado-dinamico.html`
- `resultado.html`
...
- `brand-spec.md`
- `mqa04pwj-drawing-2026-06-11T21-20-32-790Z.png`
- `mqa0r12m-drawing-2026-06-11T21-37-53-695Z.png`
- `mqa12fp6-drawing-2026-06-11T21-46-45-867Z.png`
- `mqa4fu1i-drawing-2026-06-11T23-21-09-825Z.png`
- `mqa4k2r2-drawing-2026-06-11T23-24-27-749Z.png`

## Coding checklist for AI tools
1. Inspect `acompanhar-correcao-turma.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
